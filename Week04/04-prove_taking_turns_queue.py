...
# Defect(s) Found: Error in Queue.enqueue(): function Persons were getting inserted at index zero instead of getting appended to the end of the queue
...
for i in range(10):
    players.get_next_person()
#print(players)    
# Defect(s) Found: Taking_Turns_Queue.get_next_person() lacked elif statement to handle people with ininite turns
