...
def main():
    ...
    try: 
      ...
      with open(filename, "rt") as text_file:
        ...
        while perc_reduc > 100 or perc_reduc < 0:
          perc_reduc = float(input(
            "Percent reduction of texting while driving [0, 100]: "))
          if perc_reduc < 0:
            print("Error: -5.0 is too low. Please enter a different number.")
          elif perc_reduc > 100:
            print("Error: 110.0 is too high. Please enter a different number.")
      ...
      print("[Errno 13] Permission denied: '{filename}' Please choose a different file.")

    except ValueError as error : 
     print (f"Error: could not convert string to float: '{perc_reduc}'")
