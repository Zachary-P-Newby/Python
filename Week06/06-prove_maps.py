...
def is_anagram(word1, word2):
    ...
    #for k in word1Dict:
    #    print(f"{k}: {word1Dict[k]}")
#
    #for k in word2Dict:
    #    print(f"{k}: {word2Dict[k]}")

    for l in word1Dict:
        #print(f"{l} - w1d: {word1Dict[l]} {word2Dict[l]}")
        if l not in word2Dict:
            return False
        elif word1Dict[l] < word2Dict[l] or word1Dict[l] > word2Dict[l]:
            return False
...
class Maze:
    ...
    def move_left(self):
        ...
        if self.maze_map[(self.curr_x,self.curr_y)][0]:
            ...
            print("You hit a wall and can't move")
...
def earthquake_daily_summary():
    ...
    for item in data["features"]:
        print(f'{item["properties"]["place"]} - Mag {item["properties"]["mag"]:.2f}')
#Parse the data
#WARNING!!! CONTAINS BOTH LISTS AND DICTS
